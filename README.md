...
For the paper-oriented and implementation-oriented repository guide (Chinese), see:

- `docs/REPO_ARCHITECTURE_GUIDE_CN.md`
- `docs/LLM_THESIS_REPO_GUIDE_CN.md`
- `docs/GITHUB_UPLOAD_CHECKLIST_CN.md`
- `docs/OPTIMIZATION_REPORT_V3_CN.md`
- `docs/DRIVINGFORWARD_V3_VS_ORIGINAL_CN.md`
- `docs/RESFLOW_AND_LOSS_PLAIN_CN.md`
- `docs/ABLATION_RUNBOOK_V1_CN.md`
## BibTeX
```
